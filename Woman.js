...
import foto1 from "./images/1w.jpg"; 
import foto2 from "./images/2w.jpg"; 
import foto3 from "./images/3w.jpg"; 
import foto4 from "./images/4w.jpg"; 
import foto5 from "./images/5w.jpg"; 
import foto6 from "./images/6w.jpg"; 
import foto7 from "./images/7w.jpg"; 
import foto8 from "./images/8w.jpg"; 
import foto9 from "./images/9w.jpg"; 
  ...
  return (
    <div className="catalog-page">
      ...
      <main className="catalog-content">
        <h1 className="welcome">Женский ассортимент</h1>
